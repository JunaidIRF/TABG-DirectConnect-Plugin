...
4. Go to Server Browser and press `Enter`/`Return` Key and the Direct Connect options will show up. (Leave Password Blank if no password on the server)
